...
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.size = 1;
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(chapter2_Config::AbstractParamDescriptionConstPtr(new chapter2_Config::ParamDescription<int>("size", "int", 0, "Select from the list", "{'enum_description': 'Select from the list', 'enum': [{'srcline': 13, 'description': 'Low is 0', 'srcfile': '/home/max/catkin_ws/src/chapter2_tutorials/cfg/chapter2.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Low'}, {'srcline': 14, 'description': 'Medium is 1', 'srcfile': '/home/max/catkin_ws/src/chapter2_tutorials/cfg/chapter2.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Medium'}, {'srcline': 15, 'description': 'High is 2', 'srcfile': '/home/max/catkin_ws/src/chapter2_tutorials/cfg/chapter2.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'High'}]}", &chapter2_Config::size)));
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
